...
/**
 * Created by Karthik on 2015/12/22.
 */
public class DeliveryAddressActivity extends AppCompatActivity implements View.OnClickListener, TextWatcher, AdapterView.OnItemSelectedListener {

    private final static String TAG = DeliveryAddressActivity.class.getName();

    Button btn_pickdate;

    TextInputLayout input_streetaddress_d, input_city_d, input_state_d,
            input_d_postalcode, input_valueofitem, input_tipserv, input_quantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyApplication.getInstance().trackScreenView("Delivery");
    ...
    private void menuvisibilityinAlldevices() {
        MenuVisibility.menuVisible(DeliveryAddressActivity.this);
    }
  ...
  /*  private void setItemsVisible() {
    ...
    private void callSmartyStreetForStreetValidation() {
        progressDialog = ProgressDialog.show(DeliveryAddressActivity.this, "Please wait ...", "Validating Address...", true);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, sourceUrl.toString(),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.toString().equals("[]")) {
                                ...
                                Toast.makeText(DeliveryAddressActivity.this, "Invalid Address contact support", Toast.LENGTH_LONG).show();
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(DeliveryAddressActivity.this, "Address valid", Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // progressDialog.dismiss();
                        Toast.makeText(DeliveryAddressActivity.this, error.toString(), Toast.LENGTH_LONG).show();
    ...
    private void callBuyandDeliverAPI() {
        progressDialog = ProgressDialog.show(DeliveryAddressActivity.this, "Please wait ...", "Adding Service...", true);
        progressDialog.setCancelable(false);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("false")) {
                                ...
                                String service_a_id = value_obj.getString("id");
                                ...
                                to_cal_credit.putExtra(Constants.KEY_SERVICE_A_ID, service_a_id);
                                startActivity(to_cal_credit);
                            }
                        } catch (JSONException exception) {
                            Log.e("--JSON EXCEPTION--", exception.toString());
                        }
                        //Toast.makeText(DeliveryAddressActivity.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(DeliveryAddressActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
