...
import com.doveazapp.Adapters.PartnerDetailsAdapter;
 ...
 */
public class PartnerTravelListActivity extends AppCompatActivity {
    ...
    private PartnerDetailsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PartnerDetailsAdapter(PartnerTravelListActivity.this, userDetailsList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
               ...
               /* Toast.makeText(CheckPartnerListActivity.this,
                ...
                TextView service_b_id = (TextView) v.findViewById(R.id.service_b_id);
                String userId = user_id.getText().toString();
                String serviceId = service_id.getText().toString();
                String riskscore = risk_score.getText().toString();
                String serviceb_id = service_b_id.getText().toString();
                ...
                to_details.putExtra(Constants.KEY_SERVICE_B_ID, serviceb_id);
    ...
    private void menuvisibilityinAlldevices() {
        MenuVisibility.menuVisible(PartnerTravelListActivity.this);
    }

    private void callAPI_togetuserList() {
        OnRequestCompletedListener listener = new OnRequestCompletedListener() {
            @Override
            public void onRequestCompleted(String response) {
                Log.v("--OUTPUT CONTACT LIST--", response.toString());
                ...
                try {
                    ...
                    for (int i = 0; i < userarray.length(); i++) {
                        if (status.equals("false")) {
                            ...
                            userDetails.setDelivery_date(jsonobject.getString(Constants.KEY_DELIVER_DATE));
                            userDetails.setCategory_name(jsonobject.getString(Constants.KEY_CATEGORY_NAME));
                            ...
                            userDetails.setService_b_id(jsonobject.getString(Constants.KEY_SERVICE_B_ID));
        ...
        if (contact_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, contact_verified, api_token);
        } else if (first_contact_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, first_contact_verified, api_token);
        } else if (unknown_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, unknown_verified, api_token);
        } else if (contact_not_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, contact_not_verified, api_token);
        } else if (first_contact_not_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, first_contact_not_verified, api_token);
        } else if (unknown_not_verified != null) {
            ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, unknown_not_verified, api_token);
        }
//        ServiceCalls.CallAPI_togetuserList(this, Request.Method.POST, Constants.GET_LIST_A_PROFILES, listener, contact_not_verified, api_token);
    }
    ...
    protected void onResume() {
        super.onResume();
        // Tracking the screen view
        MyApplication.getInstance().trackScreenView("PartnerTravelListActivity");
        adapter.notifyDataSetChanged();
    }
