 ...
 */
public class SendDeliverAddress extends AppCompatActivity implements View.OnClickListener, TextWatcher, AdapterView.OnItemSelectedListener {
    private final static String TAG = SendDeliverAddress.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_deliver_address);
    ...
    private void menuvisibilityinAlldevices() {
        MenuVisibility.menuVisible(SendDeliverAddress.this);
    }
...
*/
    ...
    private void callSmartyStreetForStreetValidation() {
        progressDialog = ProgressDialog.show(SendDeliverAddress.this, "Please wait ...", "Validating Address...", true);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, sourceUrl.toString(),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.toString().equals("[]")) {
                                ...
                                Toast.makeText(SendDeliverAddress.this, "Invalid Address contact support", Toast.LENGTH_LONG).show();
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(SendDeliverAddress.this, "Addresss valid", Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // progressDialog.dismiss();
                        Toast.makeText(SendDeliverAddress.this, error.toString(), Toast.LENGTH_LONG).show();
    ...
    private void callBuyandDeliverAPI() {
        progressDialog = ProgressDialog.show(SendDeliverAddress.this, "Please wait ...", "Adding Service...", true);
        progressDialog.setCancelable(false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.SAVE_BUYANDDELIVERY,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        //Toast.makeText(SendDeliverAddress.this, response, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(SendDeliverAddress.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
               ...
               /* int res_id = radiovalue.getCheckedRadioButtonId();
                ...
                params.put(Constants.KEY_SERVICETYPE, "C");
    ...
    protected void onResume() {
        super.onResume();
        // Tracking the screen view
        MyApplication.getInstance().trackScreenView("send Delivery");
    }
