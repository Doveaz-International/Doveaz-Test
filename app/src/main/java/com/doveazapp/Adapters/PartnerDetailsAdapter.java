 ...
 */
public class PartnerDetailsAdapter extends BaseAdapter {
    ...
    public PartnerDetailsAdapter(Activity activity, List<UserDetails> userDetailsList) {
        this.activity = activity;
        this.userDetailsList = userDetailsList;
    }

    public PartnerDetailsAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.partner_travel_row, null);
        ...
        TextView service_b_id = (TextView) convertView.findViewById(R.id.service_b_id);
        ...
        btnok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String type = "ENGAGE";
                String UserId = userdetails.getId();
                String serviceId = userdetails.getService_id();
                String service_b_id = userdetails.getService_b_id();
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ops.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                        ...
                        .withValue(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME, userdetails.getName())
                        .build());
        ...
        text_item.setText(userdetails.getCategory_name());
        userid.setText(userdetails.getId());
        service_id.setText(userdetails.getService_id());
        service_b_id.setText(userdetails.getService_b_id());
        thumbNail.setImageUrl(userdetails.getProfile_pic(), imageLoader);
        // title
        textName.setText(userdetails.getName());
        // travel_date
        traveldate.setText(String.valueOf(userdetails.getDelivery_date()));
        // risk
        risk_value.setText(String.valueOf(userdetails.getRisk_score()));

        double risk_score = Double.parseDouble(userdetails.getRisk_score());
        if (risk_score <= 40) {
