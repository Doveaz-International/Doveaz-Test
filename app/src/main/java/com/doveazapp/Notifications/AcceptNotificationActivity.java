 ...
 */
public class AcceptNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SentResponseAdapter(AcceptNotificationActivity.this, responseDetailsList);
    ...
    private void menuvisibilityinAlldevices() {
        MenuVisibility.menuVisible(AcceptNotificationActivity.this);
    }
