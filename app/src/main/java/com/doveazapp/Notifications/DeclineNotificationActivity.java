 ...
 */
public class DeclineNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyApplication.getInstance().trackScreenView("Decline Notification screen");
        // Session Manager
        ...
        adapter = new SentResponseAdapter(DeclineNotificationActivity.this, responseDetailsList);
    ...
    private void menuvisibilityinAlldevices() {
        MenuVisibility.menuVisible(DeclineNotificationActivity.this);
    }
        ...
        OnRequestCompletedListener listener = new OnRequestCompletedListener() {
            ...
            public void onRequestCompleted(String response) {
                ...
                try {
                    ...
                    JSONObject decline = values.getJSONObject("decline");
